...
class Plane:
    ...
    def load_model_from_urdf(self):
        ...
        orientation = bullet.getQuaternionFromEuler([0,np.radians(0),0],physicsClientId=self.clientID)

        self.planeID = bullet.loadURDF(fileName=f_name1,
                                       basePosition=[-2, 0, 0], #-10
